...
Its a work in progress, so things can/might/will change.
...
A small demo (based on scikit-learns plot_classifier_comparison) that shows the decision functions of a couple of different instantiations of the GenELMClassifier on three different datasets.
